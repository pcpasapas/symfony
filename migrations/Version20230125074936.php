 ...
 */
final class Version20230125074936 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier ADD CONSTRAINT FK_24CC0DF28441D4D9 FOREIGN KEY (alimentation_id) REFERENCES composant (id)');
